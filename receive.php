...
$logFile = file_exists(__DIR__ . '/collected_data.json') ? __DIR__ . '/collected_data.json' : __DIR__ . '/../collected_data.json';

// Serve the log file when requested directly
$uri = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
if ($uri === '/collected_data.json' || str_ends_with($uri, 'collected_data.json')) {
